...
> Answer: : Client side routing allows you to render the components much faster than server side routing because it doesnt require the page to reload.

- [ ] What does AJAX stand for?
> Answer: Asynchronous JavaScript and XML

- [ ] What are `controlled components` in React?
> Answer: A controlled component is a component that is controlled by state.
